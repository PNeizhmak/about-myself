...
### 🔗 Quick Links
[TL;DR](#-tldr) · [My Role](#-my-role) · [Main Jobs](#-my-main-jobs) · [How I Work](#️-how-i-work) · [Values](#-what-i-value) · [Working with Me](#-working-with-me) · [Style](#-my-style) · [Expectations](#-what-you-can-expect-from-me) · [Personal Notes](#️-a-few-personal-notes) · [Articles](#-articles) · [Books](#-favourite-books) · [Connect](#-connect-with-me)
...
### 🛠 My main jobs
1. **Strategy into execution** - translate company goals into clear roadmaps and track progress with the right metrics 
2. **Organizational health** – hire, scale, and support strong teams across geographies. Build structures where people do their best work
3. **Collaboration** – build strong relationships with peers, stakeholders, and partners. My goal is trust, transparency, and shared accountability 
...
5. **Bar raising** – in tech, process, or leadership — I’m always pushing us to raise the standard
...
### 📬 Connect with Me
- 💼 [LinkedIn](https://www.linkedin.com/in/pneizhmak)  
- 💻 [GitHub](https://github.com/pneizhmak)  
- ✉️ [Email](mailto:paul.neizhmak@gmail.com)

---

<sub>✨ This README is a living document. It will evolve as I learn, grow and get feedback </sub>

<!-- version: 0.0.2 (2025-08-17) -->
